...
#### Implementations
- Native: [Python](../python/native/graph_edge_list.py), [Java](../java/native/GraphEdgeList.java)
- Std-lib–based: [Python](../python/stdlib/graph_edge_list_std.py), [Java](../java/stdlib/GraphEdgeListStd.java)
