...
#### Implementations
- Native: [Python](../python/native/graph_adjacency_list.py), [Java](../java/native/GraphAdjacencyList.java)
- Std-lib–based: [Python](../python/stdlib/graph_adjacency_list_std.py), [Java](../java/stdlib/GraphAdjacencyListStd.java)
