/*
meta:
  slug: most-frequent-ip-address
  title: Most Frequent IP Address
  difficulty: easy
  ...
  time: O(n)
  space: O(n)
question: Return the most frequent IP from log lines.
approach: Count occurrences in a HashMap and pick max.
*/
